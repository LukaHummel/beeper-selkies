...
Clients with tokens not present in the new set are disconnected.
Clients with tokens that remain valid but have changed permissions (role, slot, or mk_control) receive an immediate state update without disconnection.
